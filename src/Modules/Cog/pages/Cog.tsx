...
export default function Cog() {
  ...
  // paginación FRONT (porque el controller no trae /paged)
  ...
  async function onDeactivate() {
    ...
    try {
      ...
      showToast("success", "COG desactivado correctamente");
      setMode("view");
      setSelected(null);
      await loadAll();
    } catch (e: unknown) {
...
function getDescription(r: CogRow | null): string | null {
  if (!r) return null;
  // evita cualquier inferencia rara de TS + garantiza string
